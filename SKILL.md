...
| System sleep / lid close | **launchd PAUSES.** Ticks stop. Time spent asleep is LOST (no backfill). | None — ticks resume on wake. Keep the lid open for a full day's run. |
